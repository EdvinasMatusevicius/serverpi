...
class ShellOutputHelper
{
    ...
    { //FILE NAME NULL WHILE TESTING TO SHELLTEST.TXT
        ...
        $descriptorspec = array(
            ...
            1 => array("file", storage_path()."/sh/{$fileName}/shell.txt", "w"),  // stdout is a pipe that the child will write to
            2 => array("file", storage_path()."/sh/{$fileName}/shellerrors.txt", "w") // stderr is a file to write to
